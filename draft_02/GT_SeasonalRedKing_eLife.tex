...
%We need a flexible cost-benefit framework to model the intraspecies dynamics which can be easily tuned to the particular situation.
...
\cha{One paragraph to discuss population dynamics and extinctions. Future work of  including seasonality to population dynamics. Colony Collapse disorder Apis mellifera example}

Our study shows the critical nature of mutualism and the sliver of parameter space where they are maintained. A slight change in the values can either end up in a system where one of the mutualist is completely exploited by the other species or even leads to extinction of both types in case of obligate mutualisms.
